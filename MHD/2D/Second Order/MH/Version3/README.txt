...
This code contains an implementation of the MUSCL-HANCOCK method for solving the equations of Ideal MHD in 2D. Strang-type dimensional splitting is used.
