...
!  write(15,*) Tracer(jj)%tracer_id,Tracer(jj)%cell_occupied,&
!	      Tracer(jj)%exact_cell_occupied,&
!              Tracer(jj)%current_pos,Tracer(jj)%exact_pos			
